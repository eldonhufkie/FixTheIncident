<%@ Page Title="" Language="C#" MasterPageFile="~/HelpDesk.Master" AutoEventWireup="true" CodeBehind="HelpDeskFaults.aspx.cs" Inherits="FixTheIncident.WebForm9" %>
   ...
   <div class="container">
        ...
        <div class="tab-content">
            ...
            <div id="assignedFaults" class="tab-pane fade">
                <br />
                <asp:GridView runat="server" Visible="false" ID="gvAssignedFaults" OnPageIndexChanging="gvAssignedFaults_PageIndexChanging" CssClass="table table-striped table-bordered table-condensed" AutoGenerateColumns="false" AutoGenerateSelectButton="true" OnSelectedIndexChanged="gvAssignedFaults_SelectedIndexChanged">
                    <Columns>
                        <asp:BoundField DataField="Fault Log ID" HeaderText="Fault Log ID" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden" />
                        <asp:BoundField DataField="Fault Category Name" HeaderText="Fault Category Name" />
                        <asp:BoundField DataField="Fault Type" HeaderText="Fault Type" />
